...
def run_image_batch(
    ...
    jobs: list[dict] = []
    job_stream = stream_image_jobs(batch_requests, crop_mode, sampling_params=sampling_params)
    ...
    run_streaming_generation(
        ...
        max_concurrency=max_concurrency or len(batch_requests) or 1,
    )
